...
@rmdir($runtimePath.'/temp1');

$lists[$runtimePath]['read'] = is_readable($runtimePath);
$lists[$runtimePath]['write'] = is_writable($runtimePath);
$lists[$runtimePath]['executable'] = @mkdir ($runtimePath . '/temp1');
@rmdir($runtimePath . '/temp1');
...
<div class="container">
    ...
    <form method="post" action="{{route('install.index')}}" class="form-horizontal" role="form">
        <div>
            <h4>PHP版本 <span style="font-size: 12px;">PHP版本必须大于等于7.1+</span></h4>
            <table class="table">
        ...
        <div class="form-group text-center">
            <a href="/install/next" type="submit" class="btn btn-success" id="btn-install" data-loading-text="安装中...">
                下一步
            </a>
